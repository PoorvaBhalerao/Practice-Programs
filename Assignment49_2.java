...
// reverse the contents of the row and display
...
class Assignment49_2
{
    public static void main(String[] args) 
    {
        ...
        System.out.println("Elements Before Reversing Row of matrix: ");
        mobj.Display();

        System.out.println("Elements After Reversing Row of matrix: ");
        mobj.ReverseRow();
